...
pub(crate) const VMX_PREEMPTION_TIMER_SET_VALUE: u32 = 1_000_000;

pub(crate) const QEMU_EXIT_PORT: u16 = 0x604;
pub(crate) const QEMU_EXIT_MAGIC: u64 = 0x2000;
...
pub(crate) const MSR_IA32_EFER_LMA_BIT: u64 = 1 << 10;
pub(crate) const CR0_PE: usize = 1 << 0;
